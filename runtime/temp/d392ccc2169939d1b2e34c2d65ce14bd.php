<?php /*a:2:{s:73:"C:\Users\Administrator\Desktop\tp5\application\index\view\index\home.html";i:1552095707;s:74:"C:\Users\Administrator\Desktop\tp5\application\index\view\common\base.html";i:1552028062;}*/ ?>
...
<div class="layui-row layui-col-space30" style="text-align: center;">
    ...
    <div class="layui-col-md12 layui-col-lg12 layui-col-xs12 layui-col-sm12">
        <div class="layui-row layui-col-space10" style="text-align: left;">
            <div class="layui-col-md3 layui-col-lg3 layui-col-xs3 layui-col-3 ">
                <i class="layui-icon">&#xe612;</i>&nbsp;&nbsp;&nbsp;&nbsp;当前在线
            </div>
            <div class="layui-col-md9 layui-col-lg9 layui-col-xs9 layui-col-9" style="font-weight: bold">
                <span>100</span>位
            </div>
        </div>
    </div>
